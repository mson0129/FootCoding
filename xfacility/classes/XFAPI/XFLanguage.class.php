...
class XFLanguage extends XFObject {
	...
	function XFLanguage($application=NULL, $xFacility = false) {
		...
		if($_GET['debug']==true)
			var_dump($_SERVER["HTTP_ACCEPT_LANGUAGE"], $this->browserLanguages, $this->userLanguages, $this->getLanguages, $this->postLanguages, $this->selectedLanguages);
	}
	...
	function getBrowserLanguages() {
		...
		foreach($return as $value) {
			...
			else if(strtolower($value)=="ko") { //ko - this code must be redesigned.
				$this->browserLanguages[] = "ko-kr";
			}
		}
